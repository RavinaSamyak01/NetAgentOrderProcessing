...
public class AgentActivityDetail extends BaseInit {
	...
	public void agentActivityDetailReport() throws Exception {
		...
		try {
			...
			getScreenshot(Driver, "AgentActivityDetailReportView");

			logger.info("Agent Activity Details Report Test=PASS");
			msg.append("Agent Activity Details Report Test=PASS" + "\n\n");
			setResultData("Result", 24, 5, "PASS");

		} catch (Exception AgentActivityDetailsRE) {
			logger.error(AgentActivityDetailsRE);
			getScreenshot(Driver, "AgentActivityDetailsR_error");
			logger.info("Agent Activity Details Report Test=FAIL");
			msg.append("Agent Activity Details Report Test=FAIL" + "\n\n");
			String Error = AgentActivityDetailsRE.getMessage();

			setResultData("Result", 24, 5, "FAIL");
			setResultData("Result", 24, 6, Error);
